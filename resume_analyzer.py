...
# Step-1: Extract information from the description i JSON format...
...
# created class of experience to extract information from Experiences....
...
# extract information from resume as shown json fromat
...
# convert the text extracted from the resume into json format...
...
# takes resumes from the resume folder using its path and than extraxct information in text form from resumes...
